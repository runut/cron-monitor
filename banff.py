...
def avai_checker():
  ...
  if start_date < end_date:
    ...
    for name, id in name_id_map.items():
      ...
      if r.status_code == 200:
        ...
        for availability in map_availabilities:
          ...
          if availability == 0 and avi_date == '2024-08-04':
    ...
    url = 'https://reservation.pc.gc.ca/api/availability/map?mapId=-2147483604&startDate=2024-08-24&endDate=2024-08-25&getDailyAvailability=false&isReserving=true'
    r = requests.get(url)
    if r.status_code == 200:
      data = r.json()
      map_availabilities = data["mapAvailabilities"]
